...
class _LogInState extends State<LogIn> {
  ...
  Widget formFields(String text, IconData icon, bool pass){
    return Padding(
      padding: const EdgeInsets.only(top:20.0, bottom: 10.0, right: 30.0, left: 30.0),
      child: Container(
        height: 60.0,
        ...
        child: Padding(
          ...
          child: TextFormField(
            keyboardType: pass == false ? TextInputType.emailAddress : TextInputType.visiblePassword,
            ...
            onChanged: (value){
              ...
              if(pass == false){
                if(RegExp(r"^[a-zA-Z0-9.a-zA-Z0-9.!#$%&'*+-/=?^_`{|}~]+@[a-zA-Z0-9]+\.[a-zA-Z]+").hasMatch(value) && errors.contains("Invalid Email Id.")){
                  setState((){
